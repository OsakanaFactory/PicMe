          ...
          >
            <div className="flex flex-wrap gap-2">
              {tags.map((tag) => (
                <motion.div
                  key={tag.id}
                  className="inline-flex items-center gap-2 px-3 py-1.5 bg-slate-100 text-slate-900 rounded-full text-sm border border-slate-200 transition-colors hover:bg-slate-200"
                >
